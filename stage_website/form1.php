                                        ...
                                        <form class="form_wrap" method="POST" action="form_new.php" enctype="multipart/form-data">
                                              <div class="row">     
                                               ...
                                               <div class="row">
                                                 ...
                                                 <div class="col-xl-12 col-lg-12">
                                                    <label for="select_graduation">Organization you want to apply for<span style="color:red;"><b>*</b></span></label>
                                                    <div class="filter">
                                                   ...
                                                   <h4>College</h4>
                                                    <hr style="height:4px;background: black;">
                                                        ...
                                                        <div class="col-xl-6 col-lg-6">
                                                            ...
                                                            <input type="text" id="g_degree" name="g_degree" placeholder="Graduation Degree" value="<?php echo $g_degree; ?>" required>
                                                        </div>   

                                                        <div class="col-xl-6 col-lg-6">
                                                    <label for="graduation_branch">Graduation Branch(e.g. IT, CE, EC, MECH,...)<span style="color:red;"><b>*</b></span></label>
                                                    <input type="text" id="g_branch" name="g_branch" placeholder="Graduation Branch" value="<?php echo $g_branch; ?>" required>
                                                         </div>
                                                    

                                                <div class="col-xl-6 col-lg-6">
                                                    <label for="Graduation_CGPA">Graduation CGPA/Percentage<span style="color:red;"><b>*</b></span></label>
                                                    <input type="text" id="g_cgpa" name="g_cgpa" placeholder="Graduation CGPA/Percentage" value="<?php echo $g_cgpa; ?>" required>
                                                </div>
                                                
                                                <div class="col-xl-6 col-lg-6">
                                                    <label for="year_of_graduation">Graduation Passout Year<span style="color:red;"><b>*</b></span></label>
                                                    <input type="text" id="g_year" name="g_year" placeholder="Graduation Passout Year" value="<?php echo $g_year; ?>" required>
                                                </div>
                                                
                                 
                                                <div class="col-xl-6 col-lg-6">
                                                    <label for="select_post_graduation">Master Degree(e.g. M.Tech,M.E,...)<span></span></label>
                                                    <input type="text" id="m_degree" name="m_degree" value="<?php echo $m_degree; ?>" placeholder="Master Degree">
                                                </div>
                                                
                                                <div class="col-xl-6 col-lg-6">
                                                    <label for="post_graduation_branch">Master Degree Branch(e.g. IT, CE, EC, MECH,...)<span></span></label>
                                                    <input type="text" id="m_branch" name="m_branch" placeholder="Master Degree Branch" value="<?php echo $m_branch; ?>">
                                                </div>
                                   
                                                
                                                <div class="col-xl-6 col-lg-6">
                                                    <label for="Post_CGPA">Post Graduation CGPA/ Percentage<span></span></label>
                                                    <input type="text" id="m_cgpa" name="m_cgpa" placeholder="Post Graduation CGPA/ Percentage" value="<?php echo $m_cgpa; ?>">
                                                </div>
                                                
                                                <div class="col-xl-6 col-lg-6">
                                                    <label for="year_of_post_graduation">Master Passout Year</label>
                                                    <input type="text" id="m_year" name="m_year" placeholder="Master Passout Year" value="<?php echo $m_year; ?>">
                                                </div>
                             ...
                             <!--project     -->
                                                <div>
                                                 ...
                                                 <div class="col-xl-6 col-lg-6">
                                                    ...
                                                    <input type="text" id="project_title" name="project_title" placeholder="Final Year project title" value="<?php echo $project_title; ?>" required>
                                                </div>
                                                
                                                 <div class="col-xl-6 col-lg-6">
                                                    <label for="F_technology">Final Year project Technology<span style="color:red;"><b>*</b></span></label>
                                                    <input type="text" id="project_technology" name="project_technology" placeholder="Final Year project technology" value="<?php echo $project_technology; ?>" required>
                                                </div>
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <label for="country">Domain (1st preference)<span></span></label>
                                                     <input type="text" id="domain" name="domain" placeholder="Domain" value="<?php echo $domain; ?>">
                                                </div>
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    ...
                                                    <input type="text" id="p_location" name="p_location" placeholder="Preferred Location" value="<?php echo $p_location; ?>" required>
                                                </div>
...
function myFunction() {
  var x = document.getElementById("email").value;
   window.location = 'https://stage.orena.solutions/form1.php?email=' + x;
