...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="row">
                    <div class="col-lg-6 domain-img">
                        <img src="images/domain1.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="col-lg-6 domain1">
                        <div class="container-fluid domain-box">
                            <h5>Automation</h5>
            ...
            <div class="carousel-item">
                <div class="row">
                    <div class="col-lg-6 domain-img">
                        <img src="images/domain2.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="col-lg-6 domain2">
                        <div class="container-fluid domain-box">
                            <h5>E-Commerce</h5>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <button class="orange btn">More</button>
                            <!-- </div> -->
                        </div>
                        <!-- <div class="carousel-caption d-none d-md-block"> -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 domain3">
                        <div class="container-fluid domain-box">
                            <h5>Industry 4.0</h5>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <button class="pink btn">More</button>
                            <!-- </div> -->
                        </div>
                        <!-- <div class="carousel-caption d-none d-md-block"> -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 domain5">
                        <div class="container-fluid domain-box">
                            <h5>IT and ITES</h5>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <button class="yellow btn">More</button>
                            <!-- </div> -->
                        </div>
                        <!-- <div class="carousel-caption d-none d-md-block"> -->
    ...
    <section class="counter">
        ...
        <div class="box">
            <div class="counter-box"><span class="count b">1</span>
                <p style="font-size: 1.05rem;">IP PATENT</p>
            </div>
            <div class="counter-box"><span class="count o">1500</span>
                <p style="font-size: 1.05rem;">ENGINEERS TRAINED</p>
            </div>
            <div class="counter-box"><span class="count pi">98</span>
                <p style="font-size: 1.05rem;">PLACEMENT %</p>
            </div>
            <div class="counter-box"><span class="count g">20</span>
                <p style="font-size: 1.05rem;">INTELLECTUAL PROPERTIES</p>
            </div>
            <div class="counter-box"><span class="count y">3</span>
    ...
    <section class="introduction">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 outer-box">
                <div class="inner-box">
                    <h3>Bridge for your Future</h3>
                    <P>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magni consequatur molestiae, harum,
                        vel
                    ...
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cupiditate earum suscipit ipsa
                        ratione.</p>
                    <button class="intro-btn">More</button>
                </div>
            </div>
            <div class="col-lg-8 col-md-6 img-box">
                <img class="img1" src="images/introduction.jpg" alt="">
                <img class="img2" src="images/introduction2.jpg" alt="">
            </div>
        </div>
            ...
            <div class="container course-inner-box">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 course-inner-box">
                    <div class="col course-box course-inner-box">
                        <div class="card shadow-sm">
                            <img class="bd-placeholder-img card-img" width="220" height="270"
                                src="images/Certification in GIS.jpg" alt="">
                    ...
                    <div class="col course-box">
                        <div class="card shadow-sm">
                            <img class="bd-placeholder-img card-img-top" width="100%" height="270"
                                src="images/Dataanalysis.jpg" alt="">
                    ...
                    <div class="col course-box">
                        <div class="card shadow-sm">
                            <img class="bd-placeholder-img card-img-top" width="100%" height="270"
                                src="images/Digital Electronics.jpg" alt="">
